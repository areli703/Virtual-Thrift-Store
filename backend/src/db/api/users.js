...
module.exports = class UsersDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.favorites_user = await users.getFavorites_user({
      transaction,
    });

    output.item_listings_seller = await users.getItem_listings_seller({
      transaction,
    });
    ...
    output.reviews_reviewer = await users.getReviews_reviewer({
      transaction,
    });
