...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/favorites/favoritesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureFavoritesCols';
...
const TableSampleFavorites = ({
  ...
  useEffect(() => {
    if (favoritesNotify.showNotification) {
      notify(
        favoritesNotify.typeNotification,
        favoritesNotify.textNotification,
      );
    }
  }, [favoritesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/favorites/favorites-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {favorites && Array.isArray(favorites) && !showGrid && (
        <ListFavorites
          favorites={favorites}
          loading={loading}
...
export default TableSampleFavorites;
