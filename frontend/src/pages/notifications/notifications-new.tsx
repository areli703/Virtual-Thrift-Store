...
import { create } from '../../stores/notifications/notificationsSlice';
    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          >
            <Form>
              <FormField label='NotificationID'>
                <Field
                  type='number'
...
NotificationsNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_NOTIFICATIONS'}>
      {page}
    </LayoutAuthenticated>
  );
};
