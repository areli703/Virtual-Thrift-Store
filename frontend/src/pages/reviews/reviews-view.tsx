  ...
  return (
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>ReviewID</p>
            <p>{reviews?.review_id || 'No data'}</p>
          </div>

          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>Reviewer</p>

            <p>{reviews?.reviewer?.firstName ?? 'No data'}</p>
          </div>

          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>TargetListing</p>

            <p>{reviews?.target_listing?.title ?? 'No data'}</p>
          </div>
