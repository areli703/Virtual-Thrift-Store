...
import { create } from '../../stores/favorites/favoritesSlice';
...
FavoritesNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_FAVORITES'}>
      {page}
    </LayoutAuthenticated>
  );
};
